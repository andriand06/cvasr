        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="active treeview">
                ...
                <ul class="treeview-menu">
                    <li class="active"><a href="/login"><i class="fa fa-circle-o"></i> Dashboard v1</a></li>
                ...
                <ul class="treeview-menu">
                    ...
                    <li class="treeview">
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="/adminlte/pages/layout/collapsed-sidebar.html"><i class="fa fa-circle-o"></i> Barang Keluar </a></li>
                        </ul>
                    </li>
                </ul>
